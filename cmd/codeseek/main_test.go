...
func TestPrintCodexConfigTomlDoesNotSetServiceTier(t *testing.T) {
	...
	err := codex.GenerateConfigToml(&output, "codeseek", "http://127.0.0.1:38440/v1", "",
...
func TestRunUsesXDGDefaultConfigPath(t *testing.T) {
	...
	configDir := filepath.Join(configHome, "codeseek")
